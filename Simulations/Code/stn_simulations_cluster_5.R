...
for (noise in c(0.1, 0.25, 0.5, 0.75,0.9)) {
  ...
  dat <- generate_network_data(p = 50, n = 1000, r2 = noise, groups = T, num_groups = 5, 
                               group_sizes = rep(10,5), num_signals = c(0,0,40,rep(0,2)), 
                               beta_mean = 1, beta_sd = sqrt(0.1))
...
save(sim_dat_long , file=paste0("/home/brennben/Robjects/", seed , "_stn_simulation_5.Rdata"))