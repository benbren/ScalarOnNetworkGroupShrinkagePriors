...
small_n_small_p_data_hub <- generate_network_data(small_p,small_n,sigma2_beta = 10, prop_zero = 0.8,
                                                beta_hubs = T, hub_nodes = small_nodes, hub_degrees = small_degrees)
large_n_small_p_data_hub <- generate_network_data(small_p,large_n,sigma2_beta = 10, prop_zero = 0.8,
                                                 beta_hubs = T, hub_nodes = small_nodes, hub_degrees = small_degrees)
...
small_n_large_p_data_hub <- generate_network_data(large_p,small_n,sigma2_beta = 30, prop_zero = 0.8,
                                                  beta_hubs = T, hub_nodes = large_nodes, hub_degrees = large_degrees)
large_n_large_p_data_hub <- generate_network_data(large_p,large_n,sigma2_beta = 30, prop_zero = 0.8,
                                                  beta_hubs = T, hub_nodes = large_nodes, hub_degrees = large_degrees)
